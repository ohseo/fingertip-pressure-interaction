...
public class ForceCtrlTool : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        } else if (_currIsPinching && _currIsCursorMode)
        {
            MoveCursor();
    ...
    // {
    //     TargetSphere sphere = collision.gameObject.GetComponent<TargetSphere>();
    //     sphere.transform.parent = _cursorMarker.transform;
    // }
